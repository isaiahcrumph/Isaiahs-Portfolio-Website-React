        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            <a href={props.link2Url} className="thq-body-small thq-link">
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar8-text20">#projects</span>
                </Fragment>
              )}
            </a>
            <a
          ...
          <div className="navbar8-buttons1">
            <button className="navbar8-action11 thq-button-animated thq-button-filled">
              <span>
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar8-text25">View Home</span>
                  </Fragment>
                )}
              </span>
            </button>
            <button className="navbar8-action21 thq-button-animated thq-button-outline">
              <span>
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar8-text26">View Projects</span>
                  </Fragment>
                )}
              </span>
            </button>
                      ...
                      <div className="navbar8-menu-item2">
                        ...
                        <div className="navbar8-content2">
                          <span className="navbar8-page21 thq-body-large">
                            {props.page2 ?? (
                              <Fragment>
                                <span className="navbar8-text17">Projects</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
...
Navbar8.defaultProps = {
  ...
  page3ImageSrc:
    'https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NTQ1NTg2MHw&ixlib=rb-4.0.3&q=80&w=1080',
  page3: undefined,
  ...
  link1: undefined,
  page2ImageSrc:
    'https://images.unsplash.com/photo-1596264917430-3f81b032c930?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NTQ1NTg2MHw&ixlib=rb-4.0.3&q=80&w=1080',
  page4ImageAlt: 'Contact Image',
  link2: undefined,
  page1ImageSrc:
    'https://images.unsplash.com/photo-1542330952-bffc55e812b2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NTQ1NTg1OXw&ixlib=rb-4.0.3&q=80&w=1080',
  logoSrc:
    'https://aheioqhobo.cloudimg.io/v7/_playground-bucket-v2.teleporthq.io_/84ec08e8-34e9-42c7-9445-d2806d156403/fac575ac-7a41-484f-b7ac-875042de11f8?org_if_sml=1&force_format=original',
  page2ImageAlt: 'Projects Image',
  linkUrlPage4: 'https://www.teleporthq.io',
  page1ImageAlt: 'Home Image',
  linkUrlPage2: 'https://www.teleporthq.io',
  page4ImageSrc:
    'https://images.unsplash.com/photo-1561883088-039e53143d73?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NTQ1NTg2MHw&ixlib=rb-4.0.3&q=80&w=1080',
  page1: undefined,
